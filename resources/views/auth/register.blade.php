        ...
        <div class="w-96 p-6 shadow-lg bg-white rounded-md">
            <form method="POST" action="{{route("register")}}">
                ...
                <div class="mt-3">
                    ...
                    <input type="name" id="name" class="border w-full text-base px-2 py-1 focus:outline-none  focus:ring-0 focus:border-gray-600 " placeholder="Enter name..." name="name" >
                </div>
                @error('name')
    ...
    @enderror
            ...
            @enderror 
                <div class="mt-3">
                    ...
                    <input type="password" id="password" class="border w-full text-base px-2 py-1 focus:outline-none  focus:ring-0 focus:border-gray-600 " placeholder="Confirm Password..." name="password_confirmation" >
                </div> 
                
                <div class="mt-5">
                    <button button type="submit" class="border-2  bg-cyan-500 text-white py-1 px-5 w-full rounded-md">Register</button>
                </div>
            </form>
